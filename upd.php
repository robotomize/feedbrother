...
//Создаём новый объект. Также можно писать и в процедурном стиле
    ...
    $memcache_obj->pconnect('127.0.0.1', 11211) or die("could not connect");
...
// var_dump($memcache_obj->get($_SESSION['id'].$_SESSION['id']));
  ...
  //  echo $memcache_obj->get($_SESSION['id']."groups");
   var_dump($memcache_obj->get($_SESSION['id']));
    echo "heeeeello";
 var_dump($memcache_obj->get($_SESSION['id'].$_SESSION['id']));
   // echo "hui";
   // var_dump($memcache_obj->get($_SESSION['id']."newgroupdiff"));
