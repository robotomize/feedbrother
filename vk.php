                ...
                <div class="media-body"><br>               
                    ...
                    <div class="col-md-12 friendlistscroll">
                     ...
                     for ($i=0; $i <1 ; $i++) for ($j=0; $j < count($listFriends['0']) ; $j++) 
                        {
                        ?> <a href=<?php echo "http://feedbrother.com/user/".$listFriends[$i][$j]['uid']; ?> class="friendsfont"> <div class="row"><div class="friends"><a href=<?php echo "http://feedbrother.com/user/".$listFriends[$i][$j]['uid']; ?> class="friendsfont"> <strong><b><?php echo $listFriends[$i][$j]['first_name']." ".$listFriends[$i][$j]['last_name']; ?></b></strong></a><br><a href=<?php echo "http://feedbrother.com/user/".$listFriends[$i][$j]['uid']; ?>><img src=<?php echo $listFriends[$i][$j]['photo_medium']; ?> width="60px" height="60px" class="img-circle"></a><br></div></div></a>
                        <?php
                         } 
                         ?>             
                    </div>
